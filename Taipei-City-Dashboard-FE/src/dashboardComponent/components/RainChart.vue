...
function getRainColor(value, colorLevels, maxValue = 300) {
  let baseColor = '';
  let alpha = 0;

  if (value >= 300) {
    baseColor = colorLevels[0];
    alpha = Math.max(0.5, value / 450);
  } else if (value >= 180) {
    baseColor = colorLevels[1];
    alpha = Math.max(0.4, value / 270);
  } else if (value >= 90) {
    baseColor = colorLevels[2];
    alpha = Math.max(0.4, value / 170);
  } else if (value >= 50) {
    baseColor = colorLevels[3];
    alpha = Math.max(0.4, value / 70);
  } else {
    baseColor = colorLevels[4];
    alpha = Math.max(0.4, value / 15);
  }
...
onMounted(() => {
  setInterval(() => {
    const areas = document.querySelectorAll('path.area-shape');
    const toFlash = Array.from(areas).sort(() => 0.5 - Math.random()).slice(0, 3);

    toFlash.forEach((el, idx) => {
      setTimeout(() => {
        el.classList.remove('flicker'); // 先移除動畫
        void el.offsetWidth;            // 強制 reflow
        el.classList.add('flicker');    // 再加上動畫
      }, idx * 800); // 每個相隔 1 秒
    });
  }, 6500);
});
      ...
      >
        ...
        >
          <path
            ...
            :fill="getRainColor(districtData['新莊區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['淡水區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['汐止區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['板橋區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['三重區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['樹林區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['土城區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['蘆洲區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['中和區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['永和區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['新店區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['鶯歌區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['三峽區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['瑞芳區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['五股區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['泰山區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['林口區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['深坑區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['石碇區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['坪林區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['三芝區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['石門區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['八里區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['平溪區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['雙溪區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['貢寮區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['金山區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['萬里區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['烏來區'], props.chart_config.color)"
        ...
        >
          <path
            ...
            :fill="getRainColor(districtData['北投區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['士林區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['內湖區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['中山區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['大同區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['中正區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['萬華區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['大安區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['信義區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['松山區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['南港區'], props.chart_config.color)"
          ...
          <path
            ...
            :fill="getRainColor(districtData['文山區'], props.chart_config.color)"
...
<div class="legend-vertical">
    <p>多</p>
    <div
      class="legend-gradient-vertical"
      :style="{
        background: `linear-gradient(to bottom, ${props.chart_config.color.join(', ')})`
      }"
    />
    <p>少</p>
  </div>
...
.districtchart-title-legend-vertical {
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 8px;
...
.map-content {
  max-width: calc(100% - 40px); /* 保留空間給右邊彩條 */
  flex: 1;
}

.legend-gradient-vertical {
  width: 20px;        /* 條的寬度 */
  height: 200px;      /* 條的長度（變高）← 你可以依需求調整 */
  border-radius: 4px;
