...
const districtColor = ref(props.chart_config.color[3]);
...
function calcLevel(level) {
  if (level < 26.7) return 0;
  else if (level >= 26.7 && level < 32.2) return 1;
  else if (level >= 32.2 && level < 40.6) return 2;
  else if (level >= 40.6 && level < 54.4) return 3;
  else if (level >= 54.4) return 4;
}

function getDistrictFillColor(level) {
  return props.chart_config.color[calcLevel(level)];
}
</script>
...
<template>
  <div
    v-if="activeChart === 'DistrictChartHI'"
    class="districtchart"
  >
    <div class="districtchart-title">
      <div class="districtchart-title-legend">
		...
		<div
			:style="{
				background: `linear-gradient(to left, ${props.chart_config.color[1]}, ${props.chart_config.color[4]})`,
				width: '50px',
				height: '10px',
			}"
			/>
    ...
    <div class="districtchart-chart">
      ...
      >
        ...
        >
          <path
            ...
            :fill="getDistrictFillColor(districtData['新莊區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['淡水區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['汐止區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['板橋區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['三重區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['樹林區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['土城區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['蘆洲區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['中和區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['永和區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['新店區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['鶯歌區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['三峽區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['瑞芳區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['五股區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['泰山區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['林口區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['深坑區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['石碇區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['坪林區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['三芝區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['石門區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['八里區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['平溪區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['雙溪區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['貢寮區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['金山區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['萬里區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['烏來區'])"
        ...
        >
          <path
            ...
            :fill="getDistrictFillColor(districtData['北投區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['士林區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['內湖區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['中山區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['大同區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['中正區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['萬華區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['大安區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['信義區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['松山區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['南港區'])"
          ...
          <path
            ...
            :fill="getDistrictFillColor(districtData['文山區'])"
      ...
      <Teleport to="body">
        ...
        >
          ...
          <span>{{'熱危害指數:' + districtData[targetDistrict] }}</span>
		  <span v-if="districtData[targetDistrict]<26.7">{{' 警戒程度:未達高溫風險'}}</span>
		  <span v-if="districtData[targetDistrict]>=26.7 && districtData[targetDistrict]<32.2" style="color : #1adb31">{{' 警戒程度:注意'}}</span>
		  <span v-if="districtData[targetDistrict]>=32.2 && districtData[targetDistrict]<40.6" style="color : #ebf53b">{{' 警戒程度:格外注意'}}</span>
		  <span v-if="districtData[targetDistrict]>=40.6 && districtData[targetDistrict]<54.4" style="color : #f5953b">{{' 警戒程度:危險'}}</span>
		  <span v-if="districtData[targetDistrict]>=54.4" style="color : #f53e3b">{{' 警戒程度:極度危險'}}</span>
        </div>
      </Teleport>
    </div>
  </div>
