...
import AnimateColumnChart from "./components/AnimateColumnChart.vue";
...
import AnimateColumnChartSvg from "./assets/chart/ColumnChart.svg";
...
function returnChartComponent(name, svg) {
	switch (name) {
		...
		case "AnimateColumnChart":
			return svg ? AnimateColumnChartSvg : AnimateColumnChart;
		case "DonutChart":
